...
public class ShapeMain {
    public static void main(String[] args) {
        ...
        Shape s2 = new Shape(20,"Rectangle",13);//Example of staticpkg polymorphism because decision has been made at compile time which overloaded constructor to call
